...
//        if ([DictionaryTerm MR_findFirstByAttribute:@"term" withValue:[dict objectForKey:@"term"]])
    ...
    DictionaryTerm *d = nil; //[DictionaryTerm MR_createInContext:currentContext];
...
-(void) saveSynonymToDatabase:(NSDictionary*)dict
{
    ...
    NSManagedObjectContext *currentContext = nil; //[NSManagedObjectContext MR_contextForCurrentThread];
    DictionaryTerm *term = nil; //[DictionaryTerm MR_findFirstByAttribute:@"termId" withValue:[dict objectForKey:@"id"]];
...
//    if (term && ![DictionarySynonym MR_findFirstWithPredicate:compred])
    {
        DictionarySynonym *d = nil; //[DictionarySynonym MR_createInContext:currentContext];
        d.termId = [dict objectForKey:@"id"];
...
//    if (term && ![DictionaryXRef MR_findFirstWithPredicate:compred])
    {
        DictionaryXRef *d = nil; //[DictionaryXRef MR_createInContext:currentContext];
        d.termId = [dict objectForKey:@"id"];
